   ...
   var lives1, lives2, lives3, lives4, lives;
   var coins = 0;
   var life = 4;
   var startGame;
 ...
 function preload(){
     ...
     fd = loadAnimation("fish/dead.png");
     ...
     shAA = loadAnimation("sharkAttack/attack1.png", "sharkAttack/attack2.png",
                          "sharkAttack/attack3.png", "sharkAttack/attack4.png", 
                          "sharkAttack/attack4.png", "sharkAttack/attack4.png",
                          "sharkAttack/attack3.png", "sharkAttack/attack2.png",
                          "sharkAttack/attack1.png", "sharkAttack/attack1.png",
                          "sharkAttack/attack1.png", "sharkAttack/attack1.png");
     ...
     lives1 = loadImage("life/life1.png");
     lives2 = loadImage("life/life2.png");
     lives3 = loadImage("life/life3.png");
     lives4 = loadImage("life/life4.png");
 ...
 function setup(){
     ...
     fish.addAnimation("dead", fd);
     fish.scale = 0.2;

     shark = createSprite(170, height - 100, 20, 20);
     shark.addAnimation("eat", shA);
     shark.addAnimation("attack", shAA);
     shark.scale = 0.4;
     ...
     tryAgain = createSprite(width/2, height/2 + 100, 20, 20);
     ...
     lives = createSprite(width - 70, 100, 20, 20);
     lives.addImage(lives1);
     lives.scale = 0.3;
...
if(keyDown("space")){
 ...
 if(frameCount > 14200){
  ...
  if(heartGroup.isTouching(fish) && life >= 1 && life%4 != 0){
     extraLife.play();
  ...
  if(life === 3 || life === 7 || life === 11){
     lives.addImage(lives2);
}

  if(life === 2 || life === 6 || life === 10){
     lives.addImage(lives3);
}

  if(life === 1 || life === 5 || life === 9){
     lives.addImage(lives4);
}
  ...
  if(gameState === END){
     ...
     shark.changeAnimation("attack", shAA);
     lives.visible = false;
  ...
  if(frameCount >= 0 && frameCount <= 2200){
     scrollSpeed = 0;
     x1 = 0;
     x2 = 0;
     scrollBackground1();
  ...
  if(frameCount % 160 === 0){
   ...
   var rand = Math.round(random(1, 12));
    ...
    switch(rand){
     ...
     obstacle1.setCollider("rectangle", 0, 0, 80, 300);
